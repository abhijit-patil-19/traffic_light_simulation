...
delay(100);
digitalWrite (r1, LOW);    
digitalWrite(g1,HIGH); //Sinal 1 Green
digitalWrite(r2,HIGH);
digitalWrite(r3,HIGH);
digitalWrite(r4,HIGH);
delay(4000);
...
digitalWrite(y1,HIGH); //Signal 1 Yellow
digitalWrite(r2,HIGH);
digitalWrite(r3,HIGH);
digitalWrite(r4,HIGH);
delay(2000);
...
digitalWrite(r1,HIGH); //Signal 1 Red
digitalWrite(g2,HIGH); //Signal 2 Green
digitalWrite(r3,HIGH);
digitalWrite(r4,HIGH);
delay(4000);
}
...
digitalWrite(y2,HIGH);  //Signal 2 Yellow
digitalWrite(r1,HIGH);
digitalWrite(r3,HIGH);
digitalWrite(r4,HIGH);
delay(2000);
...
digitalWrite(g3,HIGH);  //Signal 3 Green
digitalWrite(r1,HIGH);  
digitalWrite(r2,HIGH);  //Signal 2 RED
digitalWrite(r4,HIGH);
delay(4000);
}
...
digitalWrite(y3,HIGH);  //Signal 2 Yellow
digitalWrite(r1,HIGH);
digitalWrite(r2,HIGH);
digitalWrite(r4,HIGH);
delay(2000);
...
digitalWrite(g4,HIGH);  //Signal 4 Green
digitalWrite(r1,HIGH);
digitalWrite(r2,HIGH);
digitalWrite(r3,HIGH);  //Signal 3 Red
delay(4000);
}
...
digitalWrite(y4,HIGH);  //Signal 4 Yellow
digitalWrite(r1,HIGH);
digitalWrite(r2,HIGH);
digitalWrite(r3,HIGH);
delay(2000);
...
digitalWrite(y4,LOW);
digitalWrite(r4,LOW);  //Signal 4 Red
digitalWrite(r1,LOW);
